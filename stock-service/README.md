...
1. **field_maker.py** → Generates CSV files from database
2. **csv_reader.py** → Reads CSV files for API responses
3. **main.py** → FastAPI server serving the data
4. **Frontend** → Consumes API endpoints
